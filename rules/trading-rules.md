...
|---|------|------|
| 1 | RSI が売られ気味 | RSI < 40 |
| 2 | SMA20が上向き（モメンタム確認） | SMA20(現在) > SMA20(3期間前) |
| 3 | 勢いあり | MACD > シグナルライン |
...
|---|------|------|
| 1 | RSI が買われ気味 | RSI > 60 |
| 2 | SMA20が下向き（モメンタム確認） | SMA20(現在) < SMA20(3期間前) |
| 3 | 勢い弱い | MACD < シグナルライン |
...
**なぜ「価格 > SMA20」から変更したか：**
- 旧条件はMTFフィルター（SMA20 > SMA50）と組み合わせるとトレンド判定と実質同じになり、独立性が低かった
- 新条件は「位置」ではなく「方向」を見るため、他条件との独立性が高い

**なぜ3期間前と比較するか：**
- 1期間前: ノイズに敏感すぎる（1本の足で簡単にフリップ）
- 3期間前: 適度なスムージング（1hチャートなら3時間分の変化を反映）
- 5期間前: 反応が遅くなりすぎる可能性

**MACDとの関係：**
- MACDはEMA12 vs EMA26の「差」を見る（短期と中期の乖離）
- SMA20傾きはSMA20単体の「方向」を見る
- 相関はあるが、見ている情報は異なるため実用上は許容範囲
